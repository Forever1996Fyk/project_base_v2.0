...
;layui.config({
    base: ctxPath + '/lib/dist/layim/' //静态资源所在路径
}).extend({
    index: 'index' //主入口模块
}).define(["index", "layim"], function (e) {
    ...
    t.config({
        init: {url: ctxPath + '/lib/dist/layim/json/getList.json', data: {}},
        members: {url: ctxPath + '/lib/dist/layim/json/getMembers.json', data: {}},
