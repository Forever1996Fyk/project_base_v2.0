                ...
                layui.use("upload", function (o) {
                    ...
                    o.render({
                        ...
                        elem: e(l).find("input")[0],
                            ...
                            200 == e.code ? (e.data = e.data || {}, h.call(t, "img", {
                                src: e.data.src,
                                alt: e.data.title
                            }, n)) : i.msg(e.msg || "上传失败")
                        }
                        ...
                        layui.use("upload", function (o) {
                            ...
                            o.render({
                                ...
                                before: function (t) {
                                    ...
                                    if (i.close(s), 200 == t.code) t.data = t.data || {}, c.val(t.data.src), r.val(t.data.name); else var a = i.open({
                                        type: 1,
                                        anim: 2,
                                        icon: 5,
                                        title: "提示",
                        ...
                        layui.use("upload", function (s) {
                            ...
                            s.render({
                                ...
                                before: function (t) {
                                    ...
                                    if (i.close(r), 200 == t.code) t.data = t.data || {}, u.val(t.data.src); else var a = i.open({
                                        type: 1,
                                        anim: 2,
                                        icon: 5,
                                        title: "提示",
                                ...
                                before: function (t) {
                                    ...
                                    if (i.close(r), 200 == t.code) t.data = t.data || {}, c.val(t.data.src); else var a = i.open({
                                        type: 1,
                                        anim: 2,
                                        icon: 5,
                                        title: "提示",
                            ...
                            return layui.use("upload", function (t) {
                                ...
                                t = layui.upload, t.render({
                                    ...
                                    before: function (t) {
                                        ...
                                        if (i.close(e), 200 == t.code) t.data = t.data || {}, l.val(t.data.src), a.val(t.data.name); else var s = i.open({
                                            type: 1,
                                            anim: 2,
                                            icon: 5,
                                            title: "提示",
