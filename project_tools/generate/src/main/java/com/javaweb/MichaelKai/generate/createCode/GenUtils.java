package com.javaweb.MichaelKai.generate.createCode;

import com.javaweb.MichaelKai.generatorModel.Column;
import com.javaweb.MichaelKai.generatorModel.Table;
...
public class GenUtils {
	...
	public static List<String> getTemplates(){
		...
		templates.add("codeTemplate/add.html.vm");
		return templates;
	}
