...
public class FileUpload {
     ...
     * @return
     */
    public static byte[] getDefaultImg(String type) {
     ...
     * @return
     */
    public static byte[] getContentByte(String fileName) {
        try {
     ...
     * @param image
     */
    public static void outputStream(HttpServletResponse response, byte[] image) {
